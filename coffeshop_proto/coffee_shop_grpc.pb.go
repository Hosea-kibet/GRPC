...
const (
	...
	CoffeeShop_OrderStatus_FullMethodName = "/coffeeshop.CoffeeShop/OrderStatus"
)
...
type CoffeeShopClient interface {
	...
	OrderStatus(ctx context.Context, in *Receipt, opts ...grpc.CallOption) (*OrderStatusResponse, error)
}
...
func (c *coffeeShopClient) GetMenu(ctx context.Context, in *MenuRequest, opts ...grpc.CallOption) (CoffeeShop_GetMenuClient, error) {
	stream, err := c.cc.NewStream(ctx, &CoffeeShop_ServiceDesc.Streams[0], CoffeeShop_GetMenu_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *coffeeShopClient) PlaceOrder(ctx context.Context, in *Order, opts ...grpc.CallOption) (*Receipt, error) {
	out := new(Receipt)
	err := c.cc.Invoke(ctx, CoffeeShop_PlaceOrder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coffeeShopClient) OrderStatus(ctx context.Context, in *Receipt, opts ...grpc.CallOption) (*OrderStatusResponse, error) {
	out := new(OrderStatusResponse)
	err := c.cc.Invoke(ctx, CoffeeShop_OrderStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoffeeShopServer interface {
	...
	OrderStatus(context.Context, *Receipt) (*OrderStatusResponse, error)
...
func (UnimplementedCoffeeShopServer) OrderStatus(context.Context, *Receipt) (*OrderStatusResponse, error) {
...
func _CoffeeShop_OrderStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Receipt)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoffeeShopServer).OrderStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CoffeeShop_OrderStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoffeeShopServer).OrderStatus(ctx, req.(*Receipt))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CoffeeShop_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CoffeeShop_OrderStatus_Handler,
		},
	},
